...
### Paystack Keys (Live)
```env
PAYSTACK_SECRET_KEY=sk_live_[YOUR_SECRET_KEY_HERE]
PAYSTACK_PUBLIC_KEY=pk_live_[YOUR_PUBLIC_KEY_HERE]
```
**Note**: Replace with your actual Paystack keys from your dashboard
